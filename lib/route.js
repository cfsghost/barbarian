...
Route.prototype.requestHandler = function(protocol) {
	...
	res.set = function(key, value) {
		if (key == 'Content-Type')
			Internal.setMIMEType(protocol.messageObject, value);
	};

	res.status = function(code) {
		Internal.setStatus(protocol.messageObject, code);
	};

	res.send = function(data) {
		Internal.setContent(protocol.messageObject, data);
	};
	...
	res.end = function(data) {
		...
		Internal.runCallback(protocol.messageObject);
	};
